...
- Зберігати дані в LocalStorage, щоб вони не зникали після перезавантаження
  сторінки.
...
3. Контейнер для списку автомобілів — порожній список
   (`<ul class="js-list"></ul>`)

## 🎨 CSS (мінімальні вимоги):

- Оформити список автомобілів (`li`) у вигляді карток.
- Якщо авто у продажу (`onSale === true`) — додається клас `on-sale`, який
  змінює фон чи рамку елемента.
...
- При завантаженні сторінки:
  - Якщо в LocalStorage є збережені авто — підвантажити їх у змінну `cars` і
